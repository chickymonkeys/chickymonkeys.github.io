<template>
  <footer>
    <!-- github -->
    <a class="icon" href="http://github.com/chickymonkeys/" aria-label="Github profile">
    ...
    <!-- bluesky -->
    <a class="icon" href="https://bsky.app/profile/pizzigolot.to" aria-label="Bluesky profile">
...
footer {
  ...
  .index & {
    @media all and (min-width: 769px) {
      transform: translate3d(56vw, 52vw, 0);
      position: absolute;
    }
  }
